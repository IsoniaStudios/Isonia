...
namespace Isonia::Math
{
    ...
    static inline Vector3 ComputeSmoothNormalFrom4(const float* heightMap, const float dx, const float dz, const uint32_t width, const uint32_t height, const uint32_t z, const uint32_t x)
    {
    ...
    static inline Vector3 ComputeSmoothNormalFrom8(const float* heightMap, const float dx, const float dz, const uint32_t width, const uint32_t height, const uint32_t z, const uint32_t x)
    {
        const uint32_t middleIndex = z * width + x;
        const float top = heightMap[middleIndex - width];
