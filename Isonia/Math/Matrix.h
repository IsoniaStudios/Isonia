...
namespace Isonia::Math
{
	...
	public:
		...
		constexpr Matrix(const Matrix4x4& m) : value{ Vector3(m[0]), Vector3(m[1]), Vector3(m[2]) } { }
		...
		constexpr Matrix3x3 Inverse(Matrix3x3 const& m)
		{
			float determinant = (
	...
	public:
		...
		constexpr Matrix4x4 Inverse(Matrix4x4 const& m)
		{
